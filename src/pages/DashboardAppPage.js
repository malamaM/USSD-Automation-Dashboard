...
export default function DashboardAppPage() {
  ...
  useEffect(() => {
    const checkAuthentication = async () => {
      ...
      try {
        const response = await axios.get('http://vulkantechnologylabs.com/api/me');
  ...
  useEffect(() => {
    const fetchApplications = async () => {
      try {
        const response = await axios.get('http://vulkantechnologylabs.com/api/alllicenses');
  ...
  useEffect(() => {
    const fetchPendingApplicationsCount = async () => {
      try {
        const response = await axios.get('http://vulkantechnologylabs.com/api/dashboard/pending-applications-count');
  ...
  useEffect(() => {
    const fetchAwaitingActionCount = async () => {
      try {
        const response = await axios.get('http://vulkantechnologylabs.com/api/dashboard/awaiting-action-count');
        const { count } = response.data;
  ...
  useEffect(() => {
    const fetchexpiring = async () => {
      try {
        const response = await axios.get('http://vulkantechnologylabs.com/api/count-expiring-shortcodes');
  ...
  useEffect(() => {
    const fetchavailableshortcodes = async () => {
      try {
        const response = await axios.get('http://vulkantechnologylabs.com/api/shortcode/combinations');
        const { count } = response.data;
