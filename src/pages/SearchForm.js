...
//mport MenuIcon from './MenuIcon'; // Import the MenuIcon component from the appropriate file/package

const SearchForm = () => {
  const [isLoading, setIsLoading] = useState(false);
  const [isAvailable, setIsAvailable] = useState(null); // Changed initial state to null
  const {
    register,
    handleSubmit,
    formState: { errors },
