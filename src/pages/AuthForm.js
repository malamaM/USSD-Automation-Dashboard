...
const AuthForm = () => {
  ...
  /* useEffect(() => {
    const fetchCSRFToken = async () => {
      try {
        const response = await fetch('https://vulkantechnologylabs.com/token');
    ...
    const uploadCSRFToken = async (token) => {
      try {
        await axios.post('https://vulkantechnologylabs.com/upload-csrf-token', { token });
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axios.post('https://vulkantechnologylabs.com/api/login', data);
  ...
  /* const onSubmit = async (data) => {
    ...
    try {
      const response = await axios.post(
        'https://vulkantechnologylabs.com/api/rlogin',
        data,
        {
          headers: {
